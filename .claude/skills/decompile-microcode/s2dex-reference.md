...
Macros are defined in `include/2.0L/PR/gs2dex.h`. The `g*` variants take a display list pointer as the first argument; the `gs*` variants are for static display list initialization.
