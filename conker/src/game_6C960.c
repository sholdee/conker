...
void func_1502D824(struct func_1503F4B0_arg *arg0, s32 arg1, s32 *arg2);
void func_150A9984(s32 arg0, u8 arg1);
void func_1507BDB0(struct func_1503F4B0_arg *arg0, f32 arg1, s32 arg2, s32 arg3);
...
void func_1503F4B0(struct func_1503F4B0_arg *arg0) {
    struct func_1503F4B0_sp38 sp38;
    s32 temp_a1;

    sp38.unkC = 0;
    if (arg0->unk3E0[D_800BE9C0] != 0) {
        sp38.unkC = (s32) allocate_memory(0x320, 1, 2, 2);
        func_1502D824(arg0, 0, (s32 *) sp38.unkC);
        sp38.unk8 = 0x1000;
        temp_a1 = arg0->unk3E0[D_800BE9C0];
        sp38.unk0 = arg0->unk3E8[D_800BE9C0];
        func_150A81D0(&sp38.unk0, temp_a1, arg0, arg0->unk3F0, arg0->unk3F4, &sp38.unk8, 0, 0);
        func_150A9984(arg0->unk3E8[D_800BE9C0], arg0->unk3F4);
        arg0->unk3F6 = 1;
    }
